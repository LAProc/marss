...
#define ALLFU  ANYINT|ANYFPU
    ...
    const FunctionalUnitInfo fuinfo[OP_MAX_OPCODE] = {
        ...
        {OP_fcmpcc,         4, ALLFU},
          ...
          * x1 = truncate to zero
          */
        {OP_fcvt_i2s_ins,   6, ALLFU},
        {OP_fcvt_i2s_p,     6, ALLFU},
        {OP_fcvt_i2d_lo,    6, ALLFU},
        {OP_fcvt_i2d_hi,    6, ALLFU},
        {OP_fcvt_q2s_ins,   6, ALLFU},
        {OP_fcvt_q2d,       6, ALLFU},
        {OP_fcvt_s2i,       6, ALLFU},
        {OP_fcvt_s2q,       6, ALLFU},
        {OP_fcvt_s2i_p,     6, ALLFU},
        {OP_fcvt_d2i,       6, ALLFU},
        {OP_fcvt_d2q,       6, ALLFU},
        {OP_fcvt_d2i_p,     6, ALLFU},
        {OP_fcvt_d2s_ins,   6, ALLFU},
        {OP_fcvt_d2s_p,     6, ALLFU},
        {OP_fcvt_s2d_lo,    6, ALLFU},
        {OP_fcvt_s2d_hi,    6, ALLFU},
         /*
          * Vector integer uops
