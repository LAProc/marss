...
#ifdef DRAMSIM
  // DRAMSim2 options
  //dramsim_device_ini_file = "ini/DDR3_micron_16M_8B_x8_sg15.ini";
...
void ConfigurationParser<PTLsimConfig>::setup() {
 ...
 ///
  ...
  add(dramsim_outputfile, "dramsim-output-file",  "Name of the file where the DRAMSim2 output log should go"); 
#endif
